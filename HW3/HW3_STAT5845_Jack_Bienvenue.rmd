...
ct_towns_nb <- poly2nb(ct_merged_shp_sp)
...
ct_exploded <- ct_merged_shp %>%
  st_cast("POLYGON") %>%                    # Cast to single polygons
...
plot(ct_merged_shp_mainlands, border = 'lightgray', main = "CT Town Neighbors")
...
print(ct_merged_shp_mainlands$quad)
