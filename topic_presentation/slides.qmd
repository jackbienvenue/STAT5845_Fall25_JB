...
<div style="background-color: rgba(0, 0, 0, 0.6); 
              ...
              display: inline-block; 
              margin-top: 20px;">
  <p style="text-align: left; color: lightgray;">Power outages threaten human life, stifle local economies and education, and lead to dangerous conditions [1].  Modern approaches to building outage prediction models (OPMs) use a variety of methods from simple linear regression to ensemble machine learning methods [2]. </p>
 </div>
...
<section data-auto-animate>
  ...
  <ul>
    <li class="fragment">European Centre for Medium-Range Weather Forecasting (ECMWF) -- 40+ years of Connecticut weather data [3]</li>
    <li class="fragment">Eversource -- Outage Data</li>
    <li class="fragment">Eversource Energy Center -- Classified weather events</li>
    <li class="fragment">Census Bureau -- Shapefiles for CT towns [4]</li>
  </ul>
...
<ol>
  <li id="ref1">Klinger, C., Landeg, O., & Murray, V. (2014). Power outages, extreme events and health: A systematic review of the literature from 2011–2012. PLoS Currents, 6, ecurrents.dis. https://doi.org/10.1371/currents.dis.0b8aff04e5b30f0b8dd7c853d3dc2dae</li>
  <li id="ref2">Nateghi, R., Guikema, S., & Quiring, S. M. (2014). Power outage estimation for tropical cyclones: Improved accuracy with simpler models. Risk Analysis, 34(6), 1069–1078. https://doi.org/10.1111/risa.12131</li>
  <li id="ref3"> Muñoz-Sabater et al. (2021). ERA5-Land dataset. Earth Syst. Sci. Data, 13(9), 4349–4383. </li>
  <li id ="ref4"> U.S. Census Bureau, Geography Division. (2024). TIGER/Line Shapefile: 2024 state‑based county subdivisions (Connecticut towns) [Shapefile]. Released September 25, 2024. Retrieved from U.S. Census Bureau TIGER/Line Shapefiles website. </li>
</ol>

## Image & Article Credits {.scrollable}

- Pine on power lines, Eversource via FOX61 News (https://www.fox61.com/article/news/local/outreach/awareness-months/crews-busy-as-trees-fall-on-powerlines-across-the-state/520-f1f1a672-f77e-40ed-9ba4-8d3e8aec8b89)
- GIF produced from https://www.youtube.com/watch?v=KYIUiSRIHuE 